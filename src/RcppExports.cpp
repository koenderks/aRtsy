...
// iterate_planet
arma::mat iterate_planet(arma::mat X, int radius, int xcenter, int ycenter, int threshold, int iterations, double starprob, int seed, int ncolors, int colorsused);
RcppExport SEXP _aRtsy_iterate_planet(SEXP XSEXP, SEXP radiusSEXP, SEXP xcenterSEXP, SEXP ycenterSEXP, SEXP thresholdSEXP, SEXP iterationsSEXP, SEXP starprobSEXP, SEXP seedSEXP, SEXP ncolorsSEXP, SEXP colorsusedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type X(XSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(iterate_planet(X, radius, xcenter, ycenter, threshold, iterations, starprob, seed, ncolors, colorsused));
    return rcpp_result_gen;
END_RCPP
}
// iterate_strokes
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_aRtsy_iterate_planet", (DL_FUNC) &_aRtsy_iterate_planet, 10},
