...
I like pretty pictures and I like R. In the `R` package `aRtsy` I combine these two things into what people generally call generative art, resulting in some(times) nice looking pictures. 
...
You can use the `paint_strokes()` function to make your own unique portrait in this style. 
...
You can use the `paint_turmite()` function to make your own unique portrait in this style. 
...
You can use the `paint_shapes()` function to make your own unique portrait in this style. 
