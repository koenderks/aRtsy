...
The "paint strokes" algorithm is my first self-made algorithm for generative art. You can use the `paint_strokes()` function from `R/paint_strokes.R` to make your own portrait like this.
