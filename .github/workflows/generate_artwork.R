...
artwork <- switch(type,
  ...
  "23" = canvas_recaman(colors = colorPalette("random-palette"), background = colorPalette("random", 1), iterations = sample(100:1000, size = 1), curvature = runif(1, 1, 20), start = sample(1:100, size = 1), angle = sample(c(0, 45), size = 1)),
