...
artwork <- switch(type,
                  '1' = canvas_turmite(color = colorPalette('random', sample(6:10, size = 1)), background = "#050505", p = runif(1, 0.2, 0.5), width = 2000, height = 2000, noise = TRUE, iterations = 1e7),
                  ...
                  '4' = canvas_ant(colors = colorPalette('random', sample(6:20, size = 1)), background = sample(c("#fafafa", "#cc7722", "#a9d2c3", "#fc7c7c", colorPalette('random', 1)), size = 1), width = 1000, height = 1000, iterations = 1e7),
                  ...
                  '7' = canvas_forest(colors = colorPalette('random', n = sample(2:12, size = 1)), width = 1500, height = 1500),
                  '8' = canvas_circlemap(colors = colorPalette('random', sample(3:9, size = 1)), left = runif(1, -14, 1), right = runif(1, 1, 14), bottom = runif(1, -2, -1), top = runif(1, 1, 2), iterations = sample(1:30, size = 1), width = 1500, height = 1500),
                  ...
                  '13' = canvas_nebula(colorPalette('random', sample(6:10, size = 1)), k = sample(50:100, size = 1), width = 2000, height = 2000),
                  '14' = canvas_mosaic(colors = colorPalette('random', n = sample(3:10, size = 1)), maxk = sample(c(1, 2, 3, 10, 50, 100), size = 1), width = 1500, height = 1500),
                  '15' = canvas_stripes(colors = colorPalette("random", sample(10:20, size = 1)), burnin = sample(1:200, size = 1)),
                  '16' = canvas_gemstone(colors = colorPalette('random', n = sample(15:25, size = 1)), width = 1500, height = 1500),
                  '17' = canvas_blacklight(colors = colorPalette('random', n = sample(2:10, size = 1)), width = 1500, height = 1500),
