...
artwork <- switch(type,
                  ...
                  '3' = canvas_turmite(color = sample(c("#000000", colorPalette('random', 1)), size = 1), background = sample(c("#fafafa", "#cc7722", "#a9d2c3", "#fc7c7c", colorPalette('random', 1)), size = 1), p = runif(1, 0.2, 0.5), width = 1500, height = 1500),
