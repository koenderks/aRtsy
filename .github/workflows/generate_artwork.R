...
artwork <- switch(type,
  ...
  "21" = canvas_flow(colors = colorPalette("random-palette"), background = sample(c("#fafafa", "firebrick", "#f9f0e0", "black", "lavenderblush2"), size = 1), lines = sample(2000:3000, size = 1), lwd = sample(seq(0.04, 0.1, 0.01), size = 1), iterations = 500, stepmax = 0.01),
